...
public:
    ...
    {
        static const char *help = "neurai-seeder\n"
...
static const string mainnet_seeds[] = {"seed1.neuracrypt.org",
                                       "seed2.neuracrypt.org",
                                       "seed3.neuracrypt.org",
                                       "seed4.neuracrypt.org",
                                       "neurai.satopool.com"};
static const string testnet_seeds[] = {"testnet1.neuracrypt.org",
...
extern "C" void *ThreadSeeder(void *)
{
    ...
    {
        db.Add(CService("kjy2eqzk4zwi5zd3.onion", 19000), true);
    }
    do
    {
